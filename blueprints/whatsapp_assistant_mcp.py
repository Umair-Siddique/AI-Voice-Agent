...
# ========== END RESCHEDULING ==========
        ...
        "1. Create the booking with accept_payment=True (DO NOT set payment_processor yet):\n"
        "   create_booking(\n"
        "     service_id='3',\n"
        "     provider_id='2',\n"
        "     client_id='123',\n"
        ...
        "   )\n"
        "2. Extract the invoice_id from the booking result\n"
        "3. Send payment link to customer's email:\n"
        "   send_payment_link(invoice_id='<invoice_id>', message_type='email')\n"
        "4. Inform the customer: 'I've sent you a payment link via email. Please complete the payment to confirm your booking.'\n"
        "5. NEVER call accept_payment() to mark it as paid - let the customer pay through Mollie\n\n"
        ...
        "AI: [calls create_booking with accept_payment=True]\n"
