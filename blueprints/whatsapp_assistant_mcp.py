...
"4. IMPORTANT: Call get_booking_details(booking_id='<the id from step 2>') to get:\n"
"   - service_id\n"
"   - provider_id\n"
...
"9. Call edit_booking with ALL required fields:\n"
"   {\n"
...
"AI: [gets {'id': '789', 'start_date_time': '2026-01-13 14:00:00', ...}]\n"
"AI: [calls get_booking_details(booking_id='789')]\n"
"AI: [gets {'service_id': '3', 'provider_id': '2', 'duration': 75, ...}]\n"
"AI: 'I found your booking for Jan 13 at 2pm. What new date works for you?'\n"
"User: 'January 15'\n"
"AI: [calls get_available_slots(service_id='3', provider_id='2', date='2026-01-15')]\n"
"AI: 'Available times on Jan 15: 10am, 2pm, 4pm. Which one?'\n"
"User: '10am'\n"
"AI: [calculates: start='2026-01-15 10:00:00', end='2026-01-15 11:15:00' (10:00 + 75 min)]\n"
"AI: [calls edit_booking(booking_id='789', booking_data={'service_id': '3', 'provider_id': '2', 'start_datetime': '2026-01-15 10:00:00', 'end_datetime': '2026-01-15 11:15:00'})]\n"
"AI: 'Done! Moved from Jan 13 2pm to Jan 15 10am.'\n\n"
