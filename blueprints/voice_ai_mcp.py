...
def generate_voice_response(session_id: str, user_text: str) -> str:
    ...
    "5. Once you have ALL required information, present complete booking details and ask 'Should I confirm this booking for you?' - wait for user confirmation\n"
    ...
    "CONCRETE EXAMPLE - Study this format:\n"
    ...
    "  ]\n"
    "}\n"
    "You ask user: 'Do you have any injuries?' → User says 'No'\n"
    "You ask user: 'What area should we focus on?' → User says 'Core and back'\n"
    "You call create_booking with:\n"
    "{\n"
    "  \"service_id\": \"3\",\n"
    "  \"provider_id\": \"2\",\n"
    "  \"client_id\": \"316\",\n"
    "  \"start_datetime\": \"2026-01-13 13:15:00\",\n"
    "  \"additional_fields\": [\n"
